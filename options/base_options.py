...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/media/data3/zhangpz/CheckPoints/', help='models are save here')
        ...
        # input/output sizes
        parser.add_argument('--batchSize', type=int, default=13, help='input batch size')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/media/data2/zhangpz/DataSet/Fashion')
        ...
        parser.add_argument('--display_id', type=int, default=0, help='display id of the web')#1
        ...
        parser.add_argument('--use_mask', action='store_true', help='continue training: load the latest model')
