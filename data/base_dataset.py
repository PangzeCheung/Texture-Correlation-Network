...
class BaseDataset(data.Dataset):
    ...
    def initialize(self, opt):
        ...
        self.mask_folder = '/media/data3/zhangpz/DataSet/Market/pose_mask_image_test'
    ...
    def __getitem__(self, index):
        ...
        if self.use_mask:
            mask = torch.as_tensor(np.load(os.path.join(self.mask_folder, P1_name + ".npy")), dtype=torch.float)
            ...
            mask_fg = torch.mul(P1, mask)
            mask_bg = torch.mul(P1, 1 - mask)
        ...
        return {'P1': P1, 'BP1': BP1, 'P2': P2, 'BP2': BP2,
                'P1_path': P1_name, 'P2_path': P2_name, 'm_bg': mask_bg, 'm_fg': mask_fg}
